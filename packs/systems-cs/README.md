...
| **Dual Numbers** | [`autograd-lab`](https://github.com/sauloduttra/autograd-lab) | Teaches automatic differentiation in both directions — reverse-mode DAG backprop and forward-mode dual numbers — and when each one is the right tool. |
